return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>dM', dap_python.test_method, { desc = '[D]ebug [M]ethod' })
    vim.keymap.set('n', '<leader>dC', dap_python.test_class, { desc = '[D]ebug [C]lass' })
    -- Dap UI setup
    ...
    vim.keymap.set('n', '<leader>dd', dapui.toggle, { desc = '[D]ebug Show Session' })
